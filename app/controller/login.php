...
<?php
     ...
     * 
     * login gère l'authentification des utilisateurs sur le site.
     * Inclut la classe Form pour générer le formulaire de login.
     * Utilise le modèle User pour vérifier l'existence de l'utilisateur.
     * Valide le mot de passe et initialise la session.
